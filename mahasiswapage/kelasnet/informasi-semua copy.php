<?php
    ...
    $sql = "SELECT 
        ...
        lp.waktu_pindah AS waktu_pindah, 
        lp.jadwal_selesai AS pindah_jadwal_selesai
    FROM Ruangan r
    LEFT JOIN Kelas k 
...
<body>
            <main class="main-content">
                ...
                <div class="ruangan-status">
                    ...
                    <div class="ruangan" id="ruangan-<?= $id_ruangan ?>" data-id="<?= $id_ruangan ?>" data-gedung="<?= $lokasi ?>">
                        <!-- Status ruangan berdasarkan jadwal atau jadwal yang pindah ruangan -->
                        ...
                        <div class="info">
                            ...
                            <?php } elseif ($alasan_pindah) { ?>
                                <!-- menampilkan jawal kelas yang pindah -->
                                <p> <?= $nama_mata_kuliah ?> - <?= $semester . $nomor_kelas ?></p>
                                <p> <?= $nama_dosen ?></p>
                                <p><?= date('H:i', strtotime($jadwal_mulai)) . " - " . date('H:i', strtotime($jadwal_selesai)) ?></p>
                            <?php } else { ?>
 ...
 document.addEventListener("DOMContentLoaded", () => {
    const refreshInterval = 10000; // Refresh setiap 10 detik
