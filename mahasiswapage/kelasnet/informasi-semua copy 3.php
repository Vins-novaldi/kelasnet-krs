...
$sql = "SELECT 
    ...
    END AS nama_dosen,
    CASE 
        WHEN lp.id_ruangan_baru IS NOT NULL THEN lp.waktu_pindah
        ELSE k_asli.jadwal_mulai
    END AS jadwal_mulai,
    CASE 
        WHEN lp.id_ruangan_baru IS NOT NULL THEN lp.jadwal_selesai
...
WHERE 
    lp.id_ruangan_awal IS NULL 
    OR lp.id_ruangan_awal != r.id_ruangan
